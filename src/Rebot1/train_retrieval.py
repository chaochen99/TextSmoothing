...
def evaluation(model, data_loader, device, config):
    ...
    # print(f'text\nmean: {torch.mean(text_embeds.view(-1), dim=-1)}\t var: {torch.var(text_embeds.view(-1), dim=-1)}')
    # print(f'image\nmean: {torch.mean(image_embeds.view(-1), dim=-1)}\t var: {torch.var(image_embeds.view(-1), dim=-1)}')
    # print('text')
    # print(text_embeds[0])
    # print('image')
