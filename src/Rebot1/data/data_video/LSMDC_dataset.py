...
class lsmdc_dataset(Dataset):
    def __init__(self,video_root ,data_split, num_frm=4, frm_sampling_strategy="rand", max_img_size=384, video_fmt='.avi'):
        ...
        if data_split=='test':
            file = f'/nlp_group/wuxing/gaochaochen/VLP/RaP/meta_data/LSMDC/LSMDC16_challenge_1000_publictect.csv'
        elif data_split=='val' :
            file =f'/nlp_group/wuxing/gaochaochen/VLP/RaP/meta_data/LSMDC/LSMDC16_annos_val.csv'
        elif data_split=='train':
            file =f'/nlp_group/wuxing/gaochaochen/VLP/RaP/meta_data/LSMDC/LSMDC16_annos_training.csv'
        print('file')
