...
class pretrain_webvid_dataset(Dataset):
    ...
    def _load_metadata(self):
        ...
        # *****
        metadata = pd.read_csv("/nlp_group/wuxing/gaochaochen/VLP/RaP/meta_data/webvid_entity.csv")
        # ****
    ...
    def __getitem__(self, item):
        ...
        return final,final_aug,caption,'a video of '+' '.join(random.sample(sample['entities'].split(','),5))
...
class pretrain_cc3m_video_dataset(Dataset):
    ...
    def __getitem__(self, index):    
        ...
        return image_ori,image_aug, caption, 'a video of '+' '.join(random.sample(ann['entities'].split(','),5))