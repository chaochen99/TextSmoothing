...
from models.beitv2 import create_beit, process_ckpt
...
class BLIP_Pretrain(nn.Module):
    def __init__(self,                 
        ...
        self.visual_encoder, vision_width = create_beit(vit,image_size)
        ...
        if vit=='base':
            ...
            state_dict = process_ckpt(self.visual_encoder, state_dict)
        ...
        self.visual_encoder_m, vision_width = create_beit(vit,image_size)               
